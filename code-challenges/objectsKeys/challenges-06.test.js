...
const totalCharacters = (arr) => {
  ...
  arr.forEach((obj) => {
    totalnumber += [obj.name, obj.spouse, ...obj.children].filter((item) => {
      return item != null;
    }).length;
  });
  return totalnumber;
...
const houseSize = (arr) => {
  ...
  arr.forEach((obj) => {
    sizes.push({
      house: obj.house,
      members: [obj.name, obj.spouse, ...obj.children].filter((item) => {
        return item !== null;
      }).length,
    });
  });
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach((obj) => {
    survivors.push({
      house: obj.house,
      members: [obj.name, ...obj.children].length,
    });
  });
  return survivors;
};
